...
import DateTimePicker.Events exposing (onBlurWithChange, onMouseDownPreventDefault, onTouchStartPreventDefault)
...
import Html.Styled as Html exposing (Html, div, input, span, table, tbody, td, text, th, thead, tr)
import Html.Styled.Attributes exposing (attribute, css, value)
import Html.Styled.Events exposing (onClick, onFocus)
import String
import Time
...
previousYearButton config state currentDate =
    if config.allowYearNavigation then
        span
            ...
            [ DateTimePicker.Svg.doubleLeftArrow, text " " ]
...
previousButton config state currentDate =
    span
        ...
        [ DateTimePicker.Svg.leftArrow, text " " ]
...
nextButton config state currentDate =
    span
        ...
        [ DateTimePicker.Svg.rightArrow, text " " ]
...
nextYearButton config state currentDate =
    if config.allowYearNavigation then
        span
            ...
            [ DateTimePicker.Svg.doubleRightArrow, text " " ]
...
onChangeHandler pickerType stateValue _ =
    let
...
amPmPickerHandler pickerType config stateValue _ amPm =
    let
        time =
            stateValue.time
